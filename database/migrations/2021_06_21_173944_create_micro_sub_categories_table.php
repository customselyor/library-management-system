...
class CreateMicroSubCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('micro_sub_categories', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('micro_sub_category_translations', function (Blueprint $table) {
            // mandatory fields
    ...
    {
        Schema::dropIfExists('micro_sub_categories');
        Schema::dropIfExists('micro_sub_category_translations');
    }
}
