                                    ...
                                    <div class="panel-body text-center">
                                        <div class="col-md-6">
                                            ...
                                            {{-- <div class="well" style="width: 100%;">
                                                ...
                                                <input id="brightness" onchange="Page.changeBrightness();" type="range"
                                                    min="0" max="128" value="0">
                                                <label id="contrast-value" width="100">Contrast: 0</label>
                                                <input id="contrast" onchange="Page.changeContrast();" type="range"
                                                    min="0" max="64" value="0">
                                                <label id="threshold-value" width="100">Threshold: 0</label>
                                                <input id="threshold" onchange="Page.changeThreshold();" type="range"
                                                    min="0" max="512" value="0">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="thumbnail" id="result" style="display:none">
                                                ...
                                                <div class="caption">
                                                    ...
                                                    @if ($user != null)
                                                        <h1>$user->passport_seria_number</h1>
                                                    @endif
                                                </div>
