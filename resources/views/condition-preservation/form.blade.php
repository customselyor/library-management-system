                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $title=null;
                                                        if(count($conditionPreservation->translations)>0 && $conditionPreservation->translations[$k]->locale==$item->code){
                                                            $title= $conditionPreservation->translations[$k]->title;
                                                        }
                                                    @endphp
                                                    <input
                                                            type="text"
                    ...
                    <div class="card card-primary card-outline p-3">
                        <div class="card-body">
                            @php
                                $status=0;
                            @endphp
                            @if ($conditionPreservation->count()>0)
                                @php
                                    $status=$conditionPreservation->status;
                                @endphp
                            @endif
                            <div class="form-group">
