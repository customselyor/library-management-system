                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $title=null;
                                                        if(count($sourceLocationIsolation->translations)>0 && $sourceLocationIsolation->translations[$k]->locale==$item->code){
                                                            $title= $sourceLocationIsolation->translations[$k]->title;
                                                        }
                                                    @endphp
                                                    <input
                                                            type="text"
                    ...
                    <div class="card card-primary card-outline p-3">
                        <div class="card-body">
                            @php
                                $status=0;
                            @endphp
                            @if ($sourceLocationIsolation->count()>0)
                                @php
                                    $status=$sourceLocationIsolation->status;
                                @endphp
                            @endif
                            <div class="form-group">
