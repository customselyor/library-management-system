            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item "><a href="{{ url('/admin/directions') }}">{{ __('messages.directions') }}</a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('directions.index') }}"> {{ __('messages.back') }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! ($direction->status==1)?'<i class="far fa-check-circle text-success"></i>':'<i class="far fa-times-circle text-danger"></i>'; !!}
                        </div>
