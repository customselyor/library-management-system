                ...
                <div class="card">
                    <div class="card-header">
                        <div class="float-left">
                            <span class="card-title">{{ __('messages.micro_parent_categories') }}</span>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ $microParentCategory->title }}
                        </div>
                        <div class="form-group">
                            <strong>{{ __('messages.status') }}:</strong>
                            {!! ($microParentCategory->status==1)?'<i class="far fa-check-circle text-success"></i>':'<i class="far fa-times-circle text-danger"></i>'; !!}
                        </div>                         
