                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                          ...
                                          <div class="form-group">
                                            ...
                                            @php
                                                $title=null;
                                                if( count($microParentCategory->translations)>0 && $microParentCategory->translations[$k]->locale==$item->code){
                                                    $title= $microParentCategory->translations[$k]->title;
                                                }
                                            @endphp
                                            <input
                                              type="text"
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                         @php
                            $status=0;
                         @endphp
                        @if ($microParentCategory->count()>0)
                            @php
                                $status=$microParentCategory->status;
                            @endphp
                        @endif
                        <div class="form-group">
