                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-primary" href="{{ route('micro-sub-categories.index') }}"> {{ __('messages.back') }}</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {{ $microSubCategory->title }}
                        </div>
                         
                        <div class="form-group">
                            <strong>{{ __('messages.status') }}:</strong>
                            {!! ($microSubCategory->status==1)?'<i class="far fa-check-circle text-success"></i>':'<i class="far fa-times-circle text-danger"></i>'; !!}
                        </div>
                         
                        <div class="form-group">
                            <strong>{{ __('messages.micro_categories') }}:</strong>
                            {{ $microSubCategory->microCategory->title }}
                        </div>
