                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                          ...
                                          <div class="form-group">
                                            ...
                                            @php
                                                $title=null;
                                                if( count($microSubCategory->translations)>0 && $microSubCategory->translations[$k]->locale==$item->code){
                                                    $title= $microSubCategory->translations[$k]->title;
                                                }
                                            @endphp
                                            <input
                                              type="text"
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        @php
                            $status=0;
                        @endphp
                        @if ($microSubCategory->count()>0)
                            @php
                                $status=$microSubCategory->status;
                            @endphp
                        @endif
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            {{-- microCategories --}}
                            <select class="form-control" id="type" name="micro_category_id">
