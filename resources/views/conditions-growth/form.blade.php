                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @php
                                                        $title=null;
                                                        if(count($conditionsGrowth->translations)>0 && $conditionsGrowth->translations[$k]->locale==$item->code){
                                                            $title= $conditionsGrowth->translations[$k]->title;
                                                        }
                                                    @endphp
                                                    <input
                                                            type="text"
                    ...
                    <div class="card card-primary card-outline p-3">
                        <div class="card-body">
                            @php
                                $status=0;
                            @endphp
                            @if ($conditionsGrowth->count()>0)
                                @php
                                    $status=$conditionsGrowth->status;
                                @endphp
                            @endif
                            <div class="form-group">
