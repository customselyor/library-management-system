        ...
        <div class="row">
                ...
                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exists_electron_format" name="exists_electron_format">
                                <option value='0' {{($exists_electron_format)?'':'selected'}}>{{ __('messages.no') }}</option>
                                <option value='1' {{($exists_electron_format)?'selected':''}}>{{ __('messages.yes') }}</option>
                            </select>
            ...
            <div class="col-md-3">
                <div class="form-group">
                        ...
                        @if ($book->count()>0)
                            @php
                                $exists_in_library=$book->exists_in_library;
                            @endphp
                        @endif
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exists_in_library" name="exists_in_library">
                                <option value='0' {{($exists_in_library)?'':'selected'}}>{{ __('messages.no') }}</option>
                                <option value='1' {{($exists_in_library)?'selected':''}}>{{ __('messages.yes') }}</option>
                            </select>
        ...
        @if(isset($qr_lists)&&count($qr_lists)>0)
            <table class="table table-striped table-hover" >
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary " target="__blank" href="{{ route('books.exportInventarAll',$book->id) }}"><i class="fa fa-fw fa-print"></i> {{ __('messages.download') }}</a>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-primary " href="{{ route('books.exportInventar',$item->id) }}"><i class="fa fa-fw fa-download"></i> {{ __('messages.download') }}</a>
                    </td>
                </tr>
                @endforeach
            </table> 
